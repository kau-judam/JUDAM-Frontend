...
import { BreweryJournalManagePage } from "./pages/BreweryJournalManagePage";
    ...
    children: [
      ...
      // Main app with layout
      {
        ...
        children: [
          ...
          {
            path: "brewery/project/:id/journal",
            element: (
              <ProtectedRoute requiredType="brewery" requireVerified>
                <BreweryJournalManagePage />
              </ProtectedRoute>
            ),
          },
          ...
          {
            path: "archive/review/:fundingId",
            element: (
              <ProtectedRoute>
                <FundingReviewWritePage />
              </ProtectedRoute>
            ),
          },
