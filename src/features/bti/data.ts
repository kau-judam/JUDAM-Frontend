...
export const BTI_RESULTS: Record<string, BtiResultProfile> = {
  ...
  SLFC: profile('SLFC', '청량함 가득 사과 푸딩', '활기찬 일상을 즐기는 데일리 막걸러', '사과 푸딩처럼 산뜻하고 가볍게 즐기는 막걸리를 사랑하는 당신! 가벼운 바디감 덕분에 마시는 내내 부담이 없고, 톡 쏘는 탄산과 달콤한 맛은 기분 전환에 최고예요. 친구들과의 시끌벅적한 모임이나 야식 타임에 딱 어울리며, 언제 마셔도 기분 좋은 활력을 불어넣어 주는 SLFC는 막걸리 세계의 비타민이에요!', ['#산뜻한단맛', '#가벼운목넘김', '#청량한탄산', '#고소한끝맛', '#부담없는한잔', '#데일리막걸리'], ['가벼운 생막걸리', '쌀 막걸리', '캔 막걸리'], [4, 2, 5, 4, 2]),
  ...
  SLMC: profile('SLMC', '햇살 머금은 식혜', '정갈한 여유를 아는 햇살 같은 휴식주의자', '햇살 머금은 식혜처럼 은은하고 정갈한 단맛에서 평온함을 찾는 당신! 탄산의 자극 없이 깔끔하게 떨어지는 맛이 마음을 차분하게 가라앉혀 줄 때 행복해요. 곡물 본연의 깔끔한 향기를 사랑하며, 조용한 분위기에서 차분하게 즐기는 시간이 최고인 SLMC는 막걸리 세계의 힐링 존재예요!', ['#은은한단맛', '#맑은목넘김', '#탄산없음', '#깔끔한곡물향', '#부드러운여운', '#정갈한맛'], ['맑은 탁주', '단술', '가벼운 쌀막걸리'], [4, 2, 1, 4, 2]),
  ...
  DHFC: profile('DHFC', '바삭하게 터지는 현미 누룽지', '막걸리 본연의 강렬함을 즐기는 누룽지 같은 정통파', '바삭하게 터지는 현미 누룽지처럼 강렬하고 묵직한 막걸리를 사랑하는 당신! 단맛에 가려지지 않은 본연의 쌉쌀함, 묵직한 바디감, 목을 치고 올라오는 강력한 탄산 조합에 짜릿한 쾌감을 느껴요. 누룩의 쌉쌀함과 알코올의 힘을 정면으로 마주하는 걸 두려워하지 않는 DHFC인 당신은 진정한 술꾼들이 인정하는 막걸리 세계의 호랑이예요!', ['#드라이한맛', '#묵직한바디', '#강한탄산', '#전통의맛', '#깊은풍미', '#청량한타격감'], ['묵직한 생막걸리', '드라이한 탁주', '호밀 막걸리'], [1, 5, 5, 5, 2]),
