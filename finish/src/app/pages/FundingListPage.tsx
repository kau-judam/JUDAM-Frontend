...
import { Search, Plus, TrendingUp, Users, ChevronDown, Heart } from "lucide-react";
...
export function FundingListPage() {
  ...
  console.log("user?.isBreweryVerified:", user?.isBreweryVerified);
  console.log("양조장 체크:", user?.type === "brewery");
