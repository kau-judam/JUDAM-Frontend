...
const fundingProjectsData = [
  { id: 1, title: "봄을 담은 벚꽃 막걸리 프로젝트", brewery: "꽃샘양조장", breweryLogo: "🌸", location: "경기 양평", category: "막걸리", shortDescription: "우리나라 전통의 맛을 현대적으로 재해석한 막걸리입니다.", image: "https://images.unsplash.com/photo-1582204964885-7bc2d62b6917?w=1080", goalAmount: 5000000, currentAmount: 4350000, backers: 156, daysLeft: 12, status: "진행 중", startDate: "2026. 03. 20", endDate: "2026. 04. 18" },
  { id: 2, title: "전통 누룩의 재발견 - 현대적 막걸리", brewery: "술샘양조장", breweryLogo: "🍶", location: "경기 양평", category: "막걸리", shortDescription: "전통 누룩을 사용한 현대적인 막걸리를 함께 만들어요.", image: "https://images.unsplash.com/photo-1694763893369-f7affaa9155d?w=1080", goalAmount: 5000000, currentAmount: 3750000, backers: 127, daysLeft: 18, status: "진행 중", startDate: "2026. 03. 15", endDate: "2026. 04. 13" },
  { id: 3, title: "꽃향기 가득한 약주 프로젝트", brewery: "꽃담양조", breweryLogo: "🌺", location: "전북 전주", category: "약주", shortDescription: "계절의 꽃향기를 담은 프리미엄 약주입니다.", image: "https://images.unsplash.com/photo-1770734331757-f40d64eafbc2?w=1080", goalAmount: 8000000, currentAmount: 6400000, backers: 203, daysLeft: 8, status: "진행 중", startDate: "2026. 03. 25", endDate: "2026. 04. 10" },
  { id: 4, title: "증류식 소주의 부활", brewery: "안동양조", breweryLogo: "🥃", location: "경북 안동", category: "소주", shortDescription: "전통 증류식 소주의 진정한 맛을 경험해보세요.", image: "https://images.unsplash.com/photo-1766399654235-a6793895422d?w=1080", goalAmount: 10000000, currentAmount: 4500000, backers: 89, daysLeft: 22, status: "진행 중", startDate: "2026. 03. 10", endDate: "2026. 04. 20" },
  { id: 5, title: "산사 막걸리 프로젝트", brewery: "산사양조", breweryLogo: "🏔️", location: "강원 평창", category: "막걸리", shortDescription: "깨끗한 산의 기운을 담은 막걸리입니다.", image: "https://images.unsplash.com/photo-1760920193193-91dd96af7862?w=1080", goalAmount: 4000000, currentAmount: 4500000, backers: 178, daysLeft: 0, status: "성공", startDate: "2026. 02. 15", endDate: "2026. 03. 20" },
  { id: 6, title: "한라봉 소주 특별판", brewery: "제주양조", breweryLogo: "🍊", location: "제주", category: "소주", shortDescription: "제주 한라봉의 상큼함을 담은 프리미엄 소주입니다.", image: "https://images.unsplash.com/photo-1598191392914-c6b3616f6369?w=1080", goalAmount: 7000000, currentAmount: 8200000, backers: 234, daysLeft: 0, status: "성공", startDate: "2026. 02. 01", endDate: "2026. 03. 10" },
];
...
export default function FundingDetailScreen() {
  ...
  useEffect(() => {
    const found = fundingProjectsData.find(p => p.id === Number(id));
  ...
  const recommendedProjects = fundingProjectsData.filter(p => p.id !== project.id).slice(0, 4);

  const handleShare = async () => {
    try {
      await Share.share({
        message: `[주담 펀딩] ${project.title} - 지금 바로 참여해보세요!`,
        url: `https://judam.app/funding/${project.id}`,
      });
    } catch (error) {
      console.log(error);
    }
                ...
                <View style={styles.sectionCard}>
                   ...
                   <View style={{ marginBottom: 32 }}>
                     ...
                     <View style={styles.guideBox}>
                        <Text style={styles.guideBoxTitle}>후원은 '공동 기획'의 시작입니다</Text>
            ...
            <Animated.View entering={SlideInDown} style={styles.modalContent}>
               ...
               <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
                  ...
                  <View style={{ marginBottom: 24 }}>
                     ...
                     <Text style={[styles.modalTxt, { marginBottom: 16 }]}>주담에서의 후원은 단순히 만들어진 술을 구매하는 '전자상거래'가 아닙니다.</Text>
